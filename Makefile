...
#++C_LINK_FLAGS = -lm -lgsl -lgslcblas -L./libmdr-0.2.3 -lmdr -lboost_program_options
...
C++C_COMPILE_FLAGS =-Wall -Wno-deprecated -g -fopenmp -I../afni_src -Wno-long-long
#C++C_LINK_FLAGS = -lm -lgsl -lgslcblas -L./libmdr-0.2.3 -lmdr -lboost_program_options -lgomp \
	-lgomp -lmri -L$(HOME)/abin -lf2c

# Optimized parallel OpenMP
#C++C_COMPILE_FLAGS =-Wall -ansi -pedantic -O3 -DNDEBUG -fopenmp -I../afni_src -Wno-long-long
...
EC_OBJS = EC.o EvaporativeCooling.o Dataset.o DatasetInstance.o Statistics.o \
	ArffDataset.o PlinkDataset.o PlinkRawDataset.o PlinkBinaryDataset.o \
	DistanceMetrics.o ChiSquared.o FilesystemUtils.o

# ----------------------------------------------------------------- BUILD RULES

all: $(EC_PROG_NAME) is now up to date."
